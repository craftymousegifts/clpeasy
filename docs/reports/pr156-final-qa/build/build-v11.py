# Builds the v11 isolated PR #156 QA site from the committed PR head.
...
open(OUT+'/TEST-ENVIRONMENT.txt','w').write(f"CLPeasy PR #156 isolated test candidate v11 (commit {head}), served on the v10 test site.\nSupabase: CLPeasy Test ({TEST_REF}). Stripe: Sandbox (acct_1TdczqKF3jvQfgEa). Not production.\n")
json.dump(report, open(S+'/v11-report.json','w'), indent=1)
