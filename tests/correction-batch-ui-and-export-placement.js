...
(async () => {
  ...
  //        clears -- functional, not just DOM placement ───────────────
  {
    ...
    window.eval("sbClient={from:()=>({select(){return this;},eq(){return this;},single(){return Promise.resolve({data:{plan:'pro',status:'active'},error:null});}})}; isPro=true; _previewVerifiedAt=Date.now(); updateProGate();");
